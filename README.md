...
Lung Scan - сервис для автоматического определения **нормы** в КТ снимках грудной клетки. В отличие от традиционных AI решений, которые ищут конкретные патологии, наша модель определяет класс "Normal" - исследования без признаков патологии. Это помогает радиологам приоритизировать случаи, требующие внимания.
